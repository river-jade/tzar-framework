...
public class Repetitions {
  ...
  public List<Parameters> getParamsList() {
    ...
    List<Set<KeyValuePair>> keyValuePairsList = Lists.transform(generators, new Function<RepetitionGenerator<?>,
        Set<KeyValuePair>>() {
      @Override
  ...
  private static List<Parameters> cartesianProductToParametersList(Set<List<KeyValuePair>> cartesianProduct) {
    ...
    for (List<KeyValuePair> keyValuePairs : cartesianProduct) {
      parametersList.add(new Parameters(keyValuePairsToMap(keyValuePairs), Maps.<String, String>newHashMap(),
